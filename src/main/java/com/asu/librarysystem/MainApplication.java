...
//        Borrower borrower = new Borrower("Ibrahem1","111","111");
//        Library.addBorrower(borrower);
//        Customer customer=new Customer("Ibrahem2","123","111");
//        Library.addCustomer(customer);
//        Borrower borrower1 = new Borrower("Ibrahem3","111","111");
//        Library.addBorrower(borrower1);
//        Customer customer1=new Customer("Ibrahem4","123","111");
...
//        Library.writeLibrary();
         Library.readLibrary();
        DiscountHandler.readDiscount();
        ReviewHandler.readReviews();
        Library.logInByUserName("Ibrahem4","123");
...
//        Library.logInByUserName("arsany", "123");
        ...
        launch();
        Library.writeLibrary();
        DiscountHandler.writeDiscount();
        ReviewHandler.writeReviews();
